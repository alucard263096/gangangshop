...
<head>
	...
	<script type="text/javascript" charset="UTF-8" src="/gangangshop/runtime/systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/gangangshop/runtime/systemjs/artTemplate/artTemplate-plugin.js"></script>
...
<?php $query = new IQuery("order");$query->fields = "sum(order_amount) as amount,count(id) as num";$query->where = "user_id = $user_id and pay_status = 1";$items = $query->find(); foreach($items as $key => $statistics){?><?php }?>
		...
		<dl class="userinfo_box">
			...
			<table width="100%" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<td>我的邀请码：<b class="red2"><?php echo isset($this->user['invcode'])?$this->user['invcode']:"";?></b></td>
				</tr>
			</table>
