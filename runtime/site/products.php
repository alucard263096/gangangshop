...
?>
<script type="text/javascript" charset="UTF-8" src="/iwebshoptest/runtime/systemjs/artTemplate/artTemplate.js"></script><script type="text/javascript" charset="UTF-8" src="/iwebshoptest/runtime/systemjs/artTemplate/artTemplate-plugin.js"></script>
<script type="text/javascript" charset="UTF-8" src="/iwebshoptest/runtime/systemjs/cookie/jquery.cookie.js"></script>
...
<div class="wrapper clearfix container_2">
	...
	<div class="sidebar f_l">
		...
		<div class="box m_10">
			...
			<div class="content">
				<ul class="ranklist">
					<?php $query = new IQuery("order_goods as og");$query->join = "join order as o on og.order_id = o.id left join goods as lg on lg.id = og.goods_id AND lg.is_del = 0";$query->fields = "DISTINCT lg.id,lg.sell_price as price,lg.img,lg.name";$query->where = "o.user_id in ($buyer_id) AND lg.id is not null";$query->order = "o.completion_time desc";$query->limit = "5";$items = $query->find(); foreach($items as $key => $item){?>
					<li class="current">
						<a href="<?php echo IUrl::creatUrl("/site/products/id/$item[id]");?>"><img width="58px" height="58px" src="<?php echo IUrl::creatUrl("")."";?><?php echo Thumb::get($item['img'],58,58);?>"></a>
		...
		<div class="box m_10">
			...
			<div class="content">
				<ul class="ranklist">
				<?php $query = new IQuery("commend_goods as cg");$query->join = "left join goods as lg on lg.id = cg.goods_id";$query->fields = "lg.name,lg.sell_price,lg.img,lg.id";$query->where = "commend_id = 3 AND lg.is_del = 0 AND lg.id is not null";$query->order = "lg.sort asc,lg.id desc";$query->limit = "5";$items = $query->find(); foreach($items as $key => $item){?>
					<li class="current">
